        ...
        <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>Abstract</h4>
                    <p>One of the big opportunities in multi-omics analysis is the identification of interactions between molecular entities and their association with diseases. In analyzing and expressing these interactions in the search for new hypotheses, multi-omics data is often either translated into matrices containing pairwise correlations and distances, or visualized as node-link diagrams. A major problem when visualizing large networks however is the occurrence of hairball-like graphs, from which little to none information can be extracted. It is of interest to investigate subgroups of markers that are closely associated with each other, rather than just looking at the overload of all interactions. An interface that draws subnetworks based on user interaction greatly helps in enabling comprehensible, detailed analyses.
                    https://github.com/driesheylen123/BioMOBS-topological-analyses and https://ckg.readthedocs.io/en/latest/INTRO.html can be used as complementary tools to demcarcate the scope of analyses within MOBS.
                    </p>
                    <h4>User interface</h4>
                    <p>MOBS was designed with various functionalities that enable efficient analyses, and includes several interactive features to optimize the user experience.
                    </p>
                    <table class="table">
                        <thead>
                            <tr>
