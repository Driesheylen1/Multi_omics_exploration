...
with open('example.json', 'w') as f:
    ...
    const colorScale_clusters = ordinal().unknown("grey").range(schemeTableau10);
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$3, 33, 12, 1238);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let $transformX;
    	let $threshold_clust;
    	validate_store(clusterIndices, 'clusterIndices');
    	component_subscribe($$self, clusterIndices, $$value => $$invalidate(9, $clusterIndices = $$value));
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*$clusterIndices*/ 512) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 76, 4, 3059);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			add_location(title, file$2, 92, 20, 3745);
    			...
    			add_location(rect, file$2, 84, 16, 3337);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(84:12) {#each links as cell}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(g, file$2, 82, 8, 3261);
    			attr_dev(svg_1, "viewBox", `0 0 ${width$1} ${height$1}`);
    			add_location(svg_1, file$2, 81, 4, 3196);
    			attr_dev(div, "class", "mb-3");
    			add_location(div, file$2, 80, 0, 3173);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (100:12) {#each linksBrushed as link}
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			title = svg_element("title");
    			t = text(t_value);
    			add_location(title, file$1, 108, 20, 3908);
    			...
    			add_location(line, file$1, 100, 16, 3380);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(100:12) {#each linksBrushed as link}",
    		ctx
    	});
    ...
    // (114:12) {#each nodesBrushed as node}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			title = svg_element("title");
    			t = text(t_value);
    			add_location(title, file$1, 124, 20, 4918);
    			...
    			add_location(circle, file$1, 115, 16, 4224);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(114:12) {#each nodesBrushed as node}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(g0, file$1, 98, 8, 3305);
    			attr_dev(g1, "class", "nodes");
    			add_location(g1, file$1, 112, 8, 4076);
    			add_location(g2, file$1, 97, 4, 3293);
    			attr_dev(svg_1, "height", "100%");
    			attr_dev(svg_1, "viewBox", `0 0 ${width} ${height}`);
    			add_location(svg_1, file$1, 96, 0, 3218);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	validate_store(clusterIndices, 'clusterIndices');
    	component_subscribe($$self, clusterIndices, $$value => $$invalidate(16, $clusterIndices = $$value));
    	validate_store(color_method_nodes, 'color_method_nodes');
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*$clusterIndices*/ 65536) {
    			colorScale_clusters.domain($clusterIndices).unknown("grey");
    		}
